...
import axios from '../../axios-auth';
 export default {
    data () {
      return {
        email: '',age: null,password: '',confirmPassword: '',
        country: 'usa',hobbyInputs: [],terms: false
      }
    },
    methods: {
      onAddHobby () {
        const newHobby = {id: Math.random() * Math.random() * 1000,value: ''}
      ...
      onSubmit () {
        const formData = {
          ...
          hobbies: this.hobbyInputs.map(hobby => hobby.value),terms: this.terms
        }
